  ...
  return (
    <div className='documentation'>
      ...
      <section id="how-it-works">
        ...
        <p>Wykorzystuje przesył fotonów. Zgodnie z zasadą no-cloning i efektem obserwatora, każda próba przechwycenia (pomiaru) klucza przez stronę trzecią powoduje błąd transmisji i zapadnięcie stanu kwantowego. Pozwala to serwerom na natychmiastowe wykrycie podsłuchu i odrzucenia skompromitowanego klucza.</p>
